...
public class LockInternals {
    ...
    public static Collection<String> getParticipantNodes(CuratorFramework client, final String basePath, String lockName,
                                                         LockInternalsSorter sorter) throws Exception {
        ...
        try {
            ...
            while ((client.getState() == CuratorFrameworkState.STARTED) && !haveTheLock) {
                ...
                if (predicateResults.getsTheLock()) {
                    ...
                    synchronized (this) {
                        try {
                            // use getData() instead of exists() to avoid leaving unneeded watchers which is a type of resource
                            // leak
