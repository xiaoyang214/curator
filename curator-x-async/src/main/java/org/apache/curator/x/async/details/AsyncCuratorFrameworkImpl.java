...
public class AsyncCuratorFrameworkImpl implements AsyncCuratorFramework
{
    ...
    @Override
    public AsyncPathable<AsyncStage<Integer>> getAllChildrenNumber()
    {
        return new AsyncGetAllChildrenNumberBuilderImpl(client, filters);
    }

    @Override
    public AsyncPathable<AsyncStage<List<String>>> getEphemerals()
    {
        return new AsyncGetEphemeralsBuilderImpl(client, filters);
    }
